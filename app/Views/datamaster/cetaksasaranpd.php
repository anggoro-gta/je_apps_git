...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Cetak Sasaran Perangkat Daerah</h1>
                </div>
                <div class="col-sm-6">
                                    ...
                                    <?php foreach ($datausers as $k) : ?>
                                        <?php if ($k->kode_user != null && $k->kode_user != 1) { ?>
                                            <tr>
                                                ...
                                                <td><?= $k->fullname; ?></td>
                                                <td>
                                                    <a href="/masterprintsasaranpd/<?= $k->kode_user; ?>" target="_blank"><button type="button" class="btn btn-block btn-secondary"><i class="fas fa-print"></i> Print</button></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    <?php endforeach; ?>
...
<script>
    ...
    const cetaksasaranpd = document.querySelector('.ahref-cetaksasaranpd');

    lidatamaster.classList.add("menu-open");
    ahrefdatamaster.classList.add("active");
    cetaksasaranpd.classList.add("active");
</script>
