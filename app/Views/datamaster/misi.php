                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php $no = 1; ?>
                                    <?php for ($i = 0; $i < $jumlahmisi; $i++) : ?>
                                        <tr>
                                            <td><?= $no; ?></td>
                                            <td><?= $datamisi[$i]['misi']; ?></td>
                                            <td>
                                                <a href="/mastermisi/<?= $datamisi[$i]['id_misi'];; ?>"><button type="button" class="btn btn-block btn-warning"><i class="far fa-edit"></i> Edit</button></a>
...
<?php if (session()->getFlashdata('pesan') == 'merubahmisi') : ?>
    <script>
        $(function() {
