        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3><?= $tujuanpd; ?></h3>
                    <h3 class="card-title">Indikator Tujuan PD : <?= $indikator; ?></h3>
                ...
                <form action="/entrytujuanpd/updatetujuanpddetail" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="indikator_tujuanpd" value="<?= $indikator; ?>" required>
                                </div>
                            </div>

                            <?php for ($i = 0; $i < $count_indikator; $i++) : ?>
                                <?php if ($indikator_edit[$i]['tahun'] == 'mean') { ?>
                                    <input type="hidden" name="idmean" value="<?= $indikator_edit[$i]['id_tujuanpd_detail']; ?>">
                                <?php } else { ?>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label>Tahun</label>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="id<?= $indikator_edit[$i]['tahun']; ?>" value="<?= $indikator_edit[$i]['id_tujuanpd_detail']; ?>">
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
