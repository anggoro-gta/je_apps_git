...
<head>
    ...
    <!-- MDB -->
    <link rel="stylesheet" href="<?= base_url(); ?>/maintenance_assets/css/mdb.min.css" />
</head>
<body>
  <!--Main Navigation-->
  <header>
  ...
  <!--Footer-->
    ...
    <!-- MDB -->
    <script type="text/javascript" src="<?= base_url(); ?>/maintenance_assets/js/mdb.umd.min.js"></script>
</body>
</html>